...
SECRET_KEY = 'django-insecure-pm1_h5fidd!wikb0^kp#h-s1_#s3&-e0#nb(ee(bbl_ac#fb74'
...
# MEDIA / STATIC / TEMPLATES overrides
from pathlib import Path
MEDIA_URL = '/media/'
...
# ensure templates dir has our users templates
try:
    TEMPLATES[0]['DIRS'] = [BASE_DIR / 'users' / 'templates']
except Exception:
    pass
